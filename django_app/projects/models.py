...
class Project(models.Model):
    ...
    description  = models.TextField(null=True, blank = True) # Allowed to write nothing
...
class Review(models.Model):
    #owner
    project = models.ForeignKey(Project,on_delete = models.CASCADE) # Delete everything
    VOTE_TYPE = (
